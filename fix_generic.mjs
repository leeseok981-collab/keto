...
const startIdx = code.indexOf('{selectedGame && GAME_DETAILS[selectedGame] && (');
const endIdx = code.indexOf('{showEventModal && isOwner && (');

if (startIdx !== -1 && endIdx !== -1) {
    code = code.substring(0, startIdx) + genericModal + "\n\n" + code.substring(endIdx);
    fs.writeFileSync('src/App.tsx', code);
    console.log("Restored generic modal properly.");
} else {

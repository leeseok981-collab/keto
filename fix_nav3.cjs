...
// find where `{menuTab === 'inventory' && (` starts
const startIndex = code.indexOf("{menuTab === 'inventory' && (");
// find where `{/* Bottom Nav */}` starts
const endIndex = code.indexOf("{/* Bottom Nav */}");

if (startIndex !== -1 && endIndex !== -1) {
    const newContent = `{menuTab === 'inventory' && (
